...
var createAccordionDir = function createAccordionDir() {
   console.log('creating the files...');

   var dir = './partials/sections/accordion/';
   var sassDir = './assets/styles/sections/';

   _mkdirp2.default.sync(dir);
   _mkdirp2.default.sync(sassDir);
...
var createSassFile = function createSassFile() {
...
exports.default = createAccordionDir;